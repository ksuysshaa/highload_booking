...
| **Отзывы, сообщения**                    | Чат, написание/чтение отзывов                       | **L7-балансировка, очереди**                   | Меньший объём, но постоянная активность (перед заездом, после выезда). Может работать частично асинхронно                                       |
