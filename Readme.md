...
#### 3. Итоговые цифры для Booking.com
...
| **Запрос**                  | **Суточное кол-во** | **Средний RPS** | **Комментарий**                                      |
|:----------------------------|---------------------:|----------------:|:-----------------------------------------------------|
| Поиск                       | 200 млн             | ~2 300          | Списки отелей, фильтры                              |
| Просмотр отеля             | 300 млн             | ~3 470          | Фото, отзывы, описания                              |
| Создание/изменение брони    | 2 млн               | ~23             | Транзакции, оплата                                  |
| Отзывы                      | 4 млн               | ~46             | Чтение/написание                                    |
| Сообщения (чат)             | 4 млн               | ~46             | Текст + вложения                                    |
| **Итого**                   | ~510 млн            | **~5 900**      | Пики (вечером, сезон отпусков) будут выше           |

## Список источников

1. [^1]: [Анализ веб-трафика booking.com](https://www.similarweb.com/ru/website/booking.com)

2. [^2]: [Статистика Booking за 2023 год](https://www.businessofapps.com/data/booking-statistics/)
